...
let teams = [];
let resetStartScreen = (teamNames,teamColors1, teamColors2, checked) => {
    teams = [];
...
document.getElementById("rosters").innerHTML = `<input type="checkbox" id="use21Rosters" name="rosters" ${checked?"checked":""} onclick = "updateRosters()">
<label>Use 2021 IPL Rosters</label>` 
